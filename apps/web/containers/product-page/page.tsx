    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (p) {
          ...
          const result = await getProducts({ categoryId: p.categoryId, limit: 8 });
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="mb-16">
        <Tabs defaultValue="description" className="w-full">
          <TabsList className="w-full justify-start border-b rounded-none bg-transparent p-0 mb-6 overflow-x-auto flex-nowrap whitespace-nowrap scrollbar-hide">
            <TabsTrigger value="description" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent px-4 md:px-8 py-3">Description</TabsTrigger>
            <TabsTrigger value="care" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent px-4 md:px-8 py-3">Care Instructions</TabsTrigger>
            <TabsTrigger value="shipping" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent px-4 md:px-8 py-3">Shipping</TabsTrigger>
          </TabsList>
